package com.xfyh.socket.netty.netty.example.heartBeat;
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        MqttConnectVariableHeader connectVariableHeader =
                new MqttConnectVariableHeader(PROTOCOL_NAME_MQTT_3_1_1, PROTOCOL_VERSION_MQTT_3_1_1, true, true, false,
                        0, false, false, 20);
        MqttConnectPayload connectPayload = new MqttConnectPayload(clientId, null, null, userName, password.toString());
